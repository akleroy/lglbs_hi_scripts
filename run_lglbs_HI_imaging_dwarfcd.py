...
#                     'hi21cm', 'hilores', 'himidres', 'hi21cm_1p2kms']
all_line_products = ['hilores','himidres', 'hi21cm_1p2kms']
...
this_imh.loop_imaging(do_all=True, do_dirty_image=False,
                      do_export_to_fits=True, export_dirty=False)

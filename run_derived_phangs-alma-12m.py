...
this_der.set_interf_configs(skip=['12m+7m','7m'])
this_der.set_feather_configs(only=['12m+7m+tp','7m+tp'])
this_der.set_line_products(only=['co21'])
this_der.set_no_cont_products(True)

# Set steps

do_convolve = True #True
do_noise = True #True
do_strictmask = True #True
do_broadmask = False #True
do_moments = False #True
do_secondary = False #True
